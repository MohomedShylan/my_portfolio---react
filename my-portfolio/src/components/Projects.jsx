  ...
  const projectData = [
     {
      ...
      images: ["/chagas/project2.png", "/chagas/project2-b.png"],
    ...
    },
     {
      ...
      images: ["/apl/apl-auction-1.png", "/apl/apl-auction-2.png", "/apl/apl-auction-3.png", "/apl/apl-auction-4.png"],
    ...
    },
    {
      ...
      images: ["/drone/drone1.png", "/drone/drone2.png"], 
    ...
    },
   {
      ...
      images: ["/graphic/poster1.jpg", "/graphic/poster2.jpg",, "/graphic/poster.jpg", "/graphic/nametag.png"],
      icon: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="13.5" cy="6.5" r=".5"></circle><circle cx="17.5" cy="10.5" r=".5"></circle><circle cx="8.5" cy="7.5" r=".5"></circle><circle cx="6.5" cy="12.5" r=".5"></circle><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"></path></svg>
    },
   {
      id: "rescue-radar-app",
      title: "Rescue Radar",
      description: "A disaster reporting mobile application that crowdsources threat identification and alerts local communities.",
      fullDetails: "A disaster reporting mobile application developed during my 2nd year at university to enhance community safety. The app allows users to capture photos of potential threats or risky areas and share them with the community. It integrates directly with the Google Maps API for precise location tagging. When a threat is reported, users in the potentially risky area are instantly alerted via push notifications, and relevant authorities are automatically informed to ensure a rapid response.",
      tech: ["React Native", "Google Maps API", "Mobile Development", "Push Notifications"],
      images: ["/rescue/1.png", "/rescue/2.png", "/rescue/3.png", "/rescue/4.png", "/rescue/5.png", "/rescue/6.png"],
      icon: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>
    }
